            ...
            <div class="p-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-0">Placeholder: aquí irá el módulo de reportes conectado por AJAX y JSON.</p>
                    </div>
                </div>
            </div>
        </main>
...
<script>
    $(function () {
        $('#menuContainer').load('menu.php', function () {
            var currentFile = window.location.pathname.split('/').pop() || 'reportes.php';
